...
int main(int argc, char** argv){
   ...
   c:	7b058593          	addi	a1,a1,1968 # 7b8 <malloc+0xe8>
  10:	4509                	li	a0,2
  12:	00000097          	auipc	ra,0x0
  16:	5d2080e7          	jalr	1490(ra) # 5e4 <fprintf>
    exit(0);
  1a:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 382:	45a50513          	addi	a0,a0,1114 # 7d8 <digits>
 386:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 44e:	38eb8b93          	addi	s7,s7,910 # 7d8 <digits>
 ...
 58e:	24690913          	addi	s2,s2,582 # 7d0 <malloc+0x100>
        while(*s != 0){
...
free(void *ap)
{
 ...
 656:	19e7b783          	ld	a5,414(a5) # 7f0 <freep>
 ...
 684:	00e6ea63          	bltu	a3,a4,698 <free+0x50>
{
 ...
 6c6:	12f73723          	sd	a5,302(a4) # 7f0 <freep>
}
 6ca:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 6f8:	0fc53503          	ld	a0,252(a0) # 7f0 <freep>
 ...
 720:	0d490913          	addi	s2,s2,212 # 7f0 <freep>
  if(p == (char*)-1)
 724:	5afd                	li	s5,-1
 726:	a88d                	j	798 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 728:	00000797          	auipc	a5,0x0
 72c:	0d078793          	addi	a5,a5,208 # 7f8 <base>
 730:	00000717          	auipc	a4,0x0
 734:	0cf73023          	sd	a5,192(a4) # 7f0 <freep>
 738:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 75a:	08a73d23          	sd	a0,154(a4) # 7f0 <freep>
      return (void*)(p + 1);
